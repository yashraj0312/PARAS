<%@ Page Title="Review Project" Language="C#" MasterPageFile="~/Faculty/FacultyMaster.master" AutoEventWireup="true" CodeFile="ProjectReview.aspx.cs" Inherits="Faculty_ProjectReview" %>
<asp:Content ID="cntProjectReview" ContentPlaceHolderID="cphFacultyMaster" Runat="Server">
<script type="text/javascript">
                        ...
                        <asp:GridView id="gridProjectReview" runat="server" Width="100%" DataKeyNames="ProjectId" EmptyDataText="NO RECORDS!" CssClass="infotable" GridLines="None" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" OnRowDataBound="gridProjectReview_RowDataBound" >
                            <Columns>
                                ...
                                <asp:BoundField DataField="EnrollmentNumber" HeaderText="Enrollment Number" ReadOnly="True">
                                    <ItemStyle Wrap="True" Width="29%" CssClass="infotable"></ItemStyle>                                    
                                </asp:BoundField>
    ...
    <asp:Panel ID="pnlPopup" runat="server" Width="700px">
        <div>
            <table width="100%" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td style="width:70%; text-align:left; background-color:White; padding:15px 0px 5px 15px"><span class="pageTitle">Project Details</span></td>
