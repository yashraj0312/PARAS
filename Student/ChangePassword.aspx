<%@ Page Language="C#" MasterPageFile="~/Student/StudentMaster.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Student_ChangePassword" Title="Student | Change Password" %>
<asp:Content ID="cntChangePassword" ContentPlaceHolderID="cphStudentMaster" Runat="Server">
