<%@ Page Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Administrator_ChangePassword" Title="Administrator | Change Password" %>
<asp:Content ID="cntChangePassword" ContentPlaceHolderID="cphAdminMaster" Runat="Server">
