<%@ Page Title="Section Details" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="SectionDetails.aspx.cs" Inherits="Administrator_SectionListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphAdminMaster" Runat="Server">

 <script type="text/javascript">
     function Select(chkId) {
         var gridId = document.getElementById("<%= gridSectionDetails.ClientID %>");
         var cell;
    ...
    <asp:UpdatePanel ID="upSectionDetails" runat="server">
        <Triggers>
        ...
        <ContentTemplate>
            <div style="width:100%; vertical-align:top; padding-bottom:4px;"> 
                ...
                <table width="100%" cellpadding="0px" cellspacing="0px" border="0">
                    <tr>
                        <td style="width:50%; text-align:left;"><span class="pageTitle">Section List</span></td>
            ...
            <table class="tblView" cellspacing="0" cellpadding="0" width="100%">                
                <tr>
                    <td style="WIDTH: 100%; PADDING-TOP: 0px; BORDER-BOTTOM: white 1px solid">
                        <asp:GridView id="gridSectionDetails" runat="server" Width="100%" DataKeyNames="SectionId" EmptyDataText="NO RECORDS!" CssClass="infotable" GridLines="None" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" OnRowDataBound="gridSectionDetails_RowDataBound">
                            <Columns>
                                ...
                                <asp:BoundField DataField="SectionName" HeaderText="Section Name" ReadOnly="True">
                                    <ItemStyle Wrap="True" Width="21.75%" CssClass="infotable"></ItemStyle>                                    
                                </asp:BoundField>   
                ...
                <table width="100%" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td style="width:47%; text-align:left; vertical-align:middle;">
                            <asp:Button id="btnDelete" runat="server" CssClass="btnClass" Text="DELETE" OnClick="btnDelete_Click"></asp:Button>&nbsp;&nbsp;<asp:Button id="btnAdd" runat="server" CssClass="btnClass" Text="CREATE NEW SECTION" PostBackUrl="~/Administrator/SectionCreation.aspx"></asp:Button>
                        </td>
    ...
    <asp:Panel ID="pnlPopup" runat="server" Width="700px">
        <div>
            <table width="100%" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td style="width:70%; text-align:left; background-color:White; padding:15px 0px 5px 15px"><span class="pageTitle">Section Detail</span></td>
        ...
        <asp:UpdatePanel ID="upSectionDetailView" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <table width="100%" cellpadding="0px" cellspacing="0px">                                            
                    <tr>
                        <td style="width:100%; background-color:White; padding:0px 15px 15px 15px;">
                            <asp:DataList ID="dlSectionDetail" runat="server" Width="100%">
                                <ItemTemplate>
                                    <table class="tblView" width="100%" cellpadding="0px" cellspacing="0px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td" style="padding-left:0px; height:28px;">Section Name</td>
                                                <td class="td" style="text-align:center; height:28px;">:</td>
                                                <td class="td" style="height:28px;">
