<%@ Page Title="Course Details" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="CourseDetails.aspx.cs" Inherits="Administrator_CourseDetails" %>
<asp:Content ID="cntCourseDetails" ContentPlaceHolderID="cphAdminMaster" Runat="Server">
    <script type="text/javascript">
     function Select(chkId) {
         var gridId = document.getElementById("<%= gridCourseDetails.ClientID %>");
         var cell;
    ...
    <asp:UpdatePanel ID="upCourseDetails" runat="server">
        <Triggers>
        ...
        <ContentTemplate>
            <div style="width:100%; vertical-align:top; padding-bottom:4px;"> 
                ...
                <table width="100%" cellpadding="0px" cellspacing="0px" border="0">
                    <tr>
                        <td style="width:50%; text-align:left;"><span class="pageTitle">Course List</span></td>
            ...
            <table class="tblView" cellspacing="0" cellpadding="0" width="100%">                
                <tr>
                    <td style="WIDTH: 100%; PADDING-TOP: 0px; BORDER-BOTTOM: white 1px solid">
                        <asp:GridView id="gridCourseDetails" runat="server" Width="100%" DataKeyNames="CourseId" EmptyDataText="NO RECORDS!" CssClass="infotable" GridLines="None" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" EmptyDataRowStyle-Width="100%" Height="100%" OnRowDataBound="gridCourseDetails_RowDataBound">
                            <Columns>
                                ...
                                <asp:BoundField DataField="CourseFullName" HeaderText="Name" ReadOnly="True">
                                    <ItemStyle Wrap="True" Width="47%" CssClass="infotable"></ItemStyle>                                    
                                </asp:BoundField>
                                <asp:BoundField DataField="CourseDurationSemester" HeaderText="Semesters" ReadOnly="True">
                                    <ItemStyle Wrap="True" Width="40%" CssClass="infotable"></ItemStyle>                                    
                                </asp:BoundField>                                
                ...
                <table width="100%" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td style="width:47%; text-align:left; vertical-align:middle;">
                            <asp:Button id="btnDelete" runat="server" CssClass="btnClass" Text="DELETE" OnClick="btnDelete_Click"></asp:Button>&nbsp;&nbsp;<asp:Button id="btnAdd" runat="server" CssClass="btnClass" Text="CREATE NEW COURSE" PostBackUrl="~/Administrator/CourseCreation.aspx"></asp:Button>
                        </td>
    ...
    <asp:Panel ID="pnlPopup" runat="server" Width="700px">
        <div>
            <table width="100%" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td style="width:70%; text-align:left; background-color:White; padding:15px 0px 5px 15px"><span class="pageTitle">Course Detail</span></td>
        ...
        <asp:UpdatePanel ID="upCourseDetailView" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <table width="100%" cellpadding="0px" cellspacing="0px">                                            
                    <tr>
                        <td style="width:100%; background-color:White; padding:0px 15px 15px 15px;">
                            <asp:DataList ID="dlCourseDetail" runat="server" Width="100%">
                                <ItemTemplate>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td" style="height:28px;" colspan="4">
                                                    <%#DataBinder.Eval(Container.DataItem, "CourseFullName")%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td" style="padding-left:0px; height:28px;">Duration (Year)</td>
                                                <td class="td" style="text-align:center; height:28px;">:</td>
                                                <td class="td" style="height:28px;">
                                                    <%#DataBinder.Eval(Container.DataItem, "CourseDurationYear")%>
                                                </td>
                                                <td class="td" style="padding-left:0px; height:28px;">Duration (Sem)</td>
                                                <td class="td" style="text-align:center; height:28px;">:</td>
                                                <td class="td" style="height:28px;">
                                                    <%#DataBinder.Eval(Container.DataItem, "CourseDurationSemester")%>
                                                </td>
                                            </tr>                                           
